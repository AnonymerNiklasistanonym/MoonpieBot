...
$ArtifactWindowsInstaller16 = Join-Path $BinaryDir "$ApplicationName-installer-$GitBranch-windows-node-16.x.zip"
$ArtifactWindowsInstaller18 = Join-Path $BinaryDir "$ApplicationName-installer-$GitBranch-windows-node-18.x.zip"
$ArtifactLinux16 = Join-Path $BinaryDir "$ApplicationName-$GitBranch-linux-node-16.x.zip"
$ArtifactLinux18 = Join-Path $BinaryDir "$ApplicationName-$GitBranch-linux-node-18.x.zip"
$ArtifactWindows16 = Join-Path $BinaryDir "$ApplicationName-$GitBranch-windows-node-16.x.zip"

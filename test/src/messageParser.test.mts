...
import {
  ...
  pluginUppercase,
} from "../../src/info/plugins/general.mjs";
import { getTestLogger } from "./logger.mjs";
import { messageParser } from "../../src/messageParser.mjs";
import pluginsTestSuite from "./messageParser/plugins.test.mjs";
import stringsTestSuite from "./messageParser/strings.test.mjs";
// Type imports
import type {
  MacroMap,
  PluginFunc,

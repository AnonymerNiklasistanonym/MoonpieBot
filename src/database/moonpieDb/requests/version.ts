...
// Local imports
import { MoonpieDbError, versionTable } from "../info";
...
export const createEntry = async (
  ...
  const logMethod = createLogMethod(logger, "database_moonpie_version_create");
...
export const removeEntry = async (
  ...
  const logMethod = createLogMethod(logger, "database_moonpie_version_remove");
  const postResult = await db.requests.post(
    databasePath,
...
export const getEntries = async (
  ...
  const logMethod = createLogMethod(logger, "database_moonpie_version_get");

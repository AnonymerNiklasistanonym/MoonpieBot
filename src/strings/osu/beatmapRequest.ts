...
export const osuBeatmapRequest = {
  ...
  default:
    ...
    "$(OSU_SCORE=%OSU_BEATMAP_REQUEST:ID% %OSU_API:DEFAULT_USER_ID%|$(SHOW_IF_STRINGS_THE_SAME=%OSU_SCORE:EXISTS%===true| - Current top score is a %OSU_SCORE:RANK%$(SHOW_IF_NOT_EMPTY=%OSU_SCORE:MODS%| using %OSU_SCORE:MODS%))$(SHOW_IF_STRINGS_THE_SAME=%OSU_SCORE:EXISTS%===false| - No score found))",
};
...
export const osuBeatmapRequestDetailed = {
  ...
  default:
    ...
    "$(OSU_SCORE=%OSU_BEATMAP_REQUEST:ID% %OSU_API:DEFAULT_USER_ID%|$(SHOW_IF_STRINGS_THE_SAME=%OSU_SCORE:EXISTS%===true| - Current top score is a %OSU_SCORE:RANK%$(SHOW_IF_NOT_EMPTY=%OSU_SCORE:MODS%| using %OSU_SCORE:MODS%)$(SHOW_IF_NOT_UNDEFINED=%OSU_SCORE:PP%| with %OSU_SCORE:PP%pp) \\(%OSU_SCORE:COUNT_300%/%OSU_SCORE:COUNT_100%/%OSU_SCORE:COUNT_50%/%OSU_SCORE:COUNT_MISS%\\) [mc=%OSU_SCORE:MAX_COMBO%, acc=%OSU_SCORE:ACC%%] from %OSU_SCORE:DATE_MONTH% %OSU_SCORE:DATE_YEAR% $(SHOW_IF_STRINGS_THE_SAME=%OSU_SCORE:HAS_REPLAY%===true| {replay available}))$(SHOW_IF_STRINGS_THE_SAME=%OSU_SCORE:EXISTS%===false| - No score found))",
};
...
export const osuBeatmapRequestIrc = {
  ...
  default:
    ...
    "$(OSU_SCORE=%OSU_BEATMAP_REQUEST:ID% %OSU_API:DEFAULT_USER_ID%|$(SHOW_IF_STRINGS_THE_SAME=%OSU_SCORE:EXISTS%===true|%NEWLINE% > Top score: %OSU_SCORE:RANK%$(SHOW_IF_NOT_EMPTY=%OSU_SCORE:MODS%| using %OSU_SCORE:MODS%)))" +
    "$(SHOW_IF_NOT_EMPTY=%OSU_BEATMAP_REQUEST:COMMENT%|%NEWLINE% > Comment: %OSU_BEATMAP_REQUEST:COMMENT%)",
};
...
export const osuBeatmapRequestIrcDetailed = {
  ...
  default:
    ...
    "$(OSU_SCORE=%OSU_BEATMAP_REQUEST:ID% %OSU_API:DEFAULT_USER_ID%|$(SHOW_IF_STRINGS_THE_SAME=%OSU_SCORE:EXISTS%===true|%NEWLINE%> Top score: %OSU_SCORE:RANK%$(SHOW_IF_NOT_EMPTY=%OSU_SCORE:MODS%| using %OSU_SCORE:MODS%)$(SHOW_IF_NOT_UNDEFINED=%OSU_SCORE:PP%| with %OSU_SCORE:PP%pp) \\(%OSU_SCORE:COUNT_300%/%OSU_SCORE:COUNT_100%/%OSU_SCORE:COUNT_50%/%OSU_SCORE:COUNT_MISS%\\) [mc=%OSU_SCORE:MAX_COMBO%, acc=%OSU_SCORE:ACC%%] from %OSU_SCORE:DATE_MONTH% %OSU_SCORE:DATE_YEAR% $(SHOW_IF_STRINGS_THE_SAME=%OSU_SCORE:HAS_REPLAY%===true| {replay available})))" +
    "$(SHOW_IF_NOT_EMPTY=%OSU_BEATMAP_REQUEST:COMMENT%|%NEWLINE% > Comment: %OSU_BEATMAP_REQUEST:COMMENT%)",
};

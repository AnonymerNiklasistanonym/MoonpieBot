...
export enum EnvVariable {
  ...
  OSU_API_RECOGNIZE_MAP_REQUESTS_AR_RANGE_MAX = "OSU_API_RECOGNIZE_MAP_REQUESTS_AR_RANGE_MAX",
  OSU_API_RECOGNIZE_MAP_REQUESTS_AR_RANGE_MIN = "OSU_API_RECOGNIZE_MAP_REQUESTS_AR_RANGE_MIN",
  OSU_API_RECOGNIZE_MAP_REQUESTS_CS_RANGE_MAX = "OSU_API_RECOGNIZE_MAP_REQUESTS_CS_RANGE_MAX",
  OSU_API_RECOGNIZE_MAP_REQUESTS_CS_RANGE_MIN = "OSU_API_RECOGNIZE_MAP_REQUESTS_CS_RANGE_MIN",
  OSU_API_RECOGNIZE_MAP_REQUESTS_DETAILED = "OSU_API_RECOGNIZE_MAP_REQUESTS_DETAILED",
  OSU_API_RECOGNIZE_MAP_REQUESTS_MESSAGE = "OSU_API_RECOGNIZE_MAP_REQUESTS_MESSAGE",
  OSU_API_RECOGNIZE_MAP_REQUESTS_REDEEM_ID = "OSU_API_RECOGNIZE_MAP_REQUESTS_REDEEM_ID",
  OSU_API_RECOGNIZE_MAP_REQUESTS_STAR_RANGE_MAX = "OSU_API_RECOGNIZE_MAP_REQUESTS_STAR_RANGE_MAX",
  OSU_API_RECOGNIZE_MAP_REQUESTS_STAR_RANGE_MIN = "OSU_API_RECOGNIZE_MAP_REQUESTS_STAR_RANGE_MIN",
...
export const envVariableInformation: EnvVariableData[] = [
  ...
  },
  {
    ...
    name: EnvVariable.OSU_API_RECOGNIZE_MAP_REQUESTS_MESSAGE,
  },
  {
    block: EnvVariableBlock.OSU_API,
    description: "The maximum star range of maps that can be requested",
    example: "6.5",
    name: EnvVariable.OSU_API_RECOGNIZE_MAP_REQUESTS_STAR_RANGE_MAX,
  },
  {
    block: EnvVariableBlock.OSU_API,
    description: "The minimum star range of maps that can be requested",
    example: "3.9",
    name: EnvVariable.OSU_API_RECOGNIZE_MAP_REQUESTS_STAR_RANGE_MIN,
  },
  {
    block: EnvVariableBlock.OSU_API,
    description: "The maximum AR value of maps that can be requested",
    example: "10",
    name: EnvVariable.OSU_API_RECOGNIZE_MAP_REQUESTS_AR_RANGE_MAX,
  },
  {
    block: EnvVariableBlock.OSU_API,
    description: "The minimum AR value of maps that can be requested",
    example: "9",
    name: EnvVariable.OSU_API_RECOGNIZE_MAP_REQUESTS_AR_RANGE_MIN,
  },
  {
    block: EnvVariableBlock.OSU_API,
    description: "The maximum CS value of maps that can be requested",
    example: "7",
    name: EnvVariable.OSU_API_RECOGNIZE_MAP_REQUESTS_CS_RANGE_MAX,
  },
  {
    block: EnvVariableBlock.OSU_API,
    description: "The minimum CS value of maps that can be requested",
    example: "4",
    name: EnvVariable.OSU_API_RECOGNIZE_MAP_REQUESTS_CS_RANGE_MIN,
  },
  {
    block: EnvVariableBlock.OSU_API,
    default: EnvVariableOnOff.OFF,
